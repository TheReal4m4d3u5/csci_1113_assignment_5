...
// int   ii, kk; 
 ...
 d2 =  (iv1*t1) +  (.5 * (double)a2 * pow((double)t1,2));
 d3 =  (iv1*t1) +  (.5 * (double)a3 * pow((double)t1,2));
 d4 =  (iv1*t1) +  (.5 * (double)a4 * pow((double)t1,2));
 d5 =  (iv1*t1) +  (.5 * (double)a5 * pow((double)t1,2));
 d6 =  (iv2*t2) +  (.5 * (double)a6 * pow((double)t2,2));
 d7 =  (iv2*t2) +  (.5 * (double)a7 * pow((double)t2,2));
 d8 =  (iv2*t2) +  (.5 * (double)a8 * pow((double)t2,2));
 d9 =  (iv2*t2) +  (.5 * (double)a9 * pow((double)t2,2));
 d10 = (iv2*t2) +  (.5 * (double)a10* pow((double)t2,2));
